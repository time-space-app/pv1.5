...
?>
				...
				<tr>
					...
					<input type="text" name="DB_HOST" id="DB_HOST" value="<?php echo $service['credentials']['hostname']; ?>" />
					</div>
					</td>
				</tr>
				<tr>
					...
					<td>
					<div class="input-control text span3 block" data-role="input-control">
					<input type="text" name="DB_USER" id="DB_USER" value="<?php echo $service['credentials']['username']; ?>" />
					</div>
					</td>
				</tr>
				<tr>
					...
					<input type="password" size="21"  name="DB_PASSWORD" id="DB_PASSWORD" value="<?php echo $service['credentials']['password']; ?>" />
					</div>
					</td>
				</tr>
				<tr>
					...
					<td>
					<div class="input-control text span3 block" data-role="input-control">
					<input type="text" name="DB_NAME" id="DB_NAME" value="<?php echo $service['credentials']['name']; ?>" />
					</div>
					</td>
				</tr>
			</tbody>
